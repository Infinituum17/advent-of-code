...
import { countBits, getEpsilonRate, getGammaRate } from "../day-03/part-one";
import resolver1 from "../day-03/part-one";
import {
  getBitOccurrenceByIndex,
  getCO2ScrubberRating,
  getOxygenRating,
  recursiveBitSearch,
} from "../day-03/part-two";
import resolver2 from "../day-03/part-two";
